---
title: "Working at ALDI as a Cashier: Pay, Pros, Cons & What to Expect"
...
**How fast do ALDI cashiers need to scan?**
ALDI expects cashiers to maintain a scanning rate of around 40 or more items per minute. This is tracked by the system, and managers review these metrics. New hires are given time to build up speed, but it's an ongoing performance expectation.

**Is being an ALDI cashier harder than other grocery store cashier jobs?**
Most employees who've worked at other grocery stores say yes. The combination of faster scanning expectations, additional non-cashier duties, and leaner staffing makes ALDI more demanding. However, many also say the higher pay makes it worth the extra effort.

**Can you work at ALDI as a cashier with no experience?**
Absolutely. ALDI hires cashiers with no prior experience and provides on-the-job training. The role is entry-level, though the pace is faster than most entry-level jobs. If you're willing to learn and work hard, no experience is needed.

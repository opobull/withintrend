---
title: "Working at Amazon as a Warehouse Worker: Pay, Pros, Cons & What to Expect"
...
In most Amazon facilities, personal earbuds and headphones are not allowed on the warehouse floor for safety reasons. Some facilities have experimented with playing music over speakers, but this varies. The no-headphone policy is a common frustration for workers facing long, repetitive shifts.

**Is Amazon warehouse work good for part-time?**
Yes, particularly at sort centers and delivery stations where shorter shifts of 3 to 5 hours are available. The flex scheduling option allows some associates to pick shifts that fit their schedule. However, expect the work to be physically demanding regardless of shift length.
